...
def pairs_residues(PDB_file, distance):
    ...
    st = parser.get_structure('1UBQ', PDB_file)
...
## Download 1UBQ file from GitHub repository!
#curl -O https://raw.githubusercontent.com/kexi-wei/BBI---BP/main/1UBQ.pdb1.gz
##If neccessary:
#gunzip -k 1UBQ.pdb1.gz

## Or directly download decompressed one
##curl -O https://raw.githubusercontent.com/kexi-wei/BBI---BP/main/1UBQ.pdb1


#1. 
pairs_residues('1UBQ.pdb1', 4)

#2.
atoms_residue_number('1UBQ.pdb1', 8)

#3.
hydrogen_bonds('1UBQ.pdb1')

#4.
residue_type_coord('1UBQ.pdb1', 'ARG')

#5.
backbone_connectivity('1UBQ.pdb1')

#6.
disulphide_bonds('1UBQ.pdb1')

#7.
dist_by_residue('1UBQ.pdb1', 10, 20)